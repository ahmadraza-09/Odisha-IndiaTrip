...
const AboutPage = () => {
  ...
  return (
    <>
      <SEO
        title="About Odisha Indiatrip | Trusted Odisha Travel Agency"
        description="Learn about Odisha Indiatrip, a trusted Odisha travel agency offering Puri tours, Chilika Lake trips, Odisha holiday packages, family vacations, tribal tours, and local travel experiences."
